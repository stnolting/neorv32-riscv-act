...
// [hack] SAIL seems to use its own RVMODEL_MTIME_ADDRESS
// -> make RVMODEL_MSIP_ADDRESS relative to RVMODEL_MTIME_ADDRESS
#define RVMODEL_MSIP_ADDRESS     (RVMODEL_MTIME_ADDRESS - 0xBFF8)
